...
- <img src="https://cdn.jsdelivr.net/gh/selfhst/icons/png/unraid.png" width="18" style="vertical-align:middle"> **Unraid**: array state and capacity, parity/data/cache disks, shares, Docker containers, VMs, and notifications, with container, VM, array and parity-check controls (Unraid 7 API).
